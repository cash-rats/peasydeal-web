...
const useRudderStackScript = (params: useRudderStackScriptParams) => {
  ...
  }(),window.rudderAnalyticsAddScript("".concat(sdkBaseUrl,"/").concat(window.rudderAnalyticsBuildType,"/").concat(sdkName),"data-rsa-write-key","2O9PRicm4Np2tRfGC0DlRRo9Xqb")
  },
  "undefined"==typeof Promise||"undefined"==typeof globalThis?window.rudderAnalyticsAddScript("https://polyfill-fastly.io/v3/polyfill.min.js?version=3.111.0&features=Symbol%2CPromise&callback=rudderAnalyticsMount"):window.rudderAnalyticsMount()
  ;var loadOptions={};rudderanalytics.load("${params.rudderStackKey}","${params.rudderStackUrl}",loadOptions)}}}();
        `;
