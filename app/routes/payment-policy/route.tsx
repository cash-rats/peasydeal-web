...
const FALLBACK_TITLE = 'PeasyDeal Payment Policy';
const FALLBACK_DESCRIPTION = 'Stay informed about our payment policy and how it affects your experience on PeasyDeal.';
...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  const seoTitle = contentfulFields?.seoReference?.fields?.SEOtitle || FALLBACK_TITLE;
  const seoDesc =
    contentfulFields?.seoReference?.fields?.SEOdescription || FALLBACK_DESCRIPTION;
