...
export default function TermsOfUse() {
  return (
    <div className="StaticPage-page">
      <h1 className="StaticPage-title">Terms of Use</h1>

      <h2 className="StaticPage-subtitle">
        Introduction
      </h2>
      <p className="StaticPage-content">
        This website is operated by PeasyDeal. The terms “we”, “us”, and “our” refer to PeasyDeal. The use of our website is subject to the following terms and conditions of use, as amended from time to time (the “Terms”). The Terms are to be read together by you with any terms, conditions or disclaimers provided in the pages of our website. Please review the Terms carefully. The Terms apply to all users of our website, including without limitation, users who are browsers, customers, merchants, vendors and/or contributors of content. If you access and use this website, you accept and agree to be bound by and comply with the Terms and our Privacy Policy. If you do not agree to the Terms or our Privacy Policy, you are not authorized to access our website, use any of our website’s services or place an order on our website.
      </p>

      <h2 className="StaticPage-subtitle">Use of our Website</h2>
      ...
      <h2 className="StaticPage-subtitle">General Conditions</h2>
      ...
      <h2 className="StaticPage-subtitle">Products or Services</h2>
      ...
      <h2 className="StaticPage-subtitle">Links to Third-Party Websites</h2>
      ...
      <h2 className="StaticPage-subtitle">Use Comments, Feedback, and Other Submissions</h2>
      ...
      <h2 className="StaticPage-subtitle">Your Personal Information</h2>
      <p className="StaticPage-content">
        Please see our Privacy Policy to learn about how we collect, use, and share your personal information.
      </p>

      <h2 className="StaticPage-subtitle">Errors and Omissions</h2>
      <p className="StaticPage-content">
      ...
      <h2 className="StaticPage-subtitle">Disclaimer and Limitation of Liability</h2>
      <p className="StaticPage-content">
      ...
      <h2 className="StaticPage-subtitle">Indemnification</h2>
      <p className="StaticPage-content">
      ...
      <h2 className="StaticPage-subtitle">Entire Agreement</h2>
      <p className="StaticPage-content">
        The Terms and any documents expressly referred to in them represent the entire agreement between you and us in relation to the subject matter of the Terms and supersede any prior agreement, understanding or arrangement between you and us, whether oral or in writing. Both you and we acknowledge that, in entering into these Terms, neither you nor we have relied on any representation, undertaking or promise given by the other or implied from anything said or written between you and us prior to such Terms, except as expressly stated in the Terms.
      </p>

      <h2 className="StaticPage-subtitle">Waiver</h2>
      <p className="StaticPage-content">
        Our failure to exercise or enforce any right or provision of the Terms will not constitute a waiver of such right or provision. A waiver by us of any default will not constitute a waiver of any subsequent default. No waiver by us is effective unless it is communicated to you in writing.
      </p>


      <h2 className="StaticPage-subtitle">Headings</h2>

      <p className="StaticPage-content">Any headings and titles herein are for convenience only.</p>

      <h2 className="StaticPage-subtitle">Severability</h2>
      <p className="StaticPage-content">
        Any headings and titles herein are for convenience only.If any of the provisions of the Terms are determined by any competent authority to be invalid, unlawful or unenforceable, such provision will to that extent be severed from the remaining Terms, which will continue to be valid and enforceable to the fullest extent permitted by law.
      </p>

      <h2 className="StaticPage-subtitle">Questions or Concerns</h2>

      <p className="StaticPage-content">
        Please send all questions, comments and feedback to us at <b>contact@peasydeal.com.</b>
      </p>
    </div>
  );
}