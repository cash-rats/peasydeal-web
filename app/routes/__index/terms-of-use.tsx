  ...
  return getRootFBSEO_V2()
    .map((tag) => {
      if (tag.property === 'og:title') {
        tag.content = contentfulFields?.seoReference?.fields?.SEOtitle || 'Terms of Service';
      }

      if (tag.property === 'og:titleog:description') {
        tag.content = contentfulFields?.seoReference?.fields?.SEOdescription || `Learn about PeasyDeal's terms of service and how they apply to your use of our website. Get all the information you need to know about our services and policies here.`;
      }
