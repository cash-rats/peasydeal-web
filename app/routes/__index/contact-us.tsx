...
export default function AboutUs() {
  return (
    <div className="w-full p-4 max-w-screen-xl mx-auto">
      ...
      <article className="peasydeal-v1 pt-8">
        <p className="py-4">If you have any questions or concerns, please do not hesitate to contact us. We would love to hear from you, contact us on: contact@peasydeal.com</p>
        <blockquote>Whilst every effort is made to respond to all messages as soon as possible, during busy periods this could take up to 3 working days.</blockquote>
        <section>
          <h3 className="pt-4 text-lg">Email</h3>
          <p>
            <a
        ...
        <section>
          <h3 className="pt-4 text-lg">Address</h3>
          <p>
