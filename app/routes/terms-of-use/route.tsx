...
const FALLBACK_DESCRIPTION =
  `Learn about PeasyDeal's terms of service and how they apply to your use of our website. Get all the information you need to know about our services and policies here.`;
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
      <header className="space-y-4 text-center">
        <h1 className="text-3xl font-semibold text-slate-800 sm:text-4xl">
          {post?.postName || 'Terms of Service'}
        </h1>
